  ...
  return (
    <div className="bg-zinc-900/50 border border-zinc-800 p-6 rounded-2xl shadow-xl backdrop-blur-sm mt-8">
      <div className="flex items-center gap-2 mb-6">
        ...
        <h2 className="text-xl font-semibold text-white">Optical Power Calculator</h2>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="flex flex-col justify-center space-y-4">
          <div className={`p-6 rounded-2xl border ${statusColors[result.status]} transition-colors`}>
            <div className="flex items-center justify-between mb-4">
              <span className="text-sm font-bold uppercase tracking-wider opacity-70">Output Laser</span>
              <Activity size={18} />
            </div>
            <div className="flex items-baseline gap-2">
              <span className="text-4xl font-black">{result.outputLaser}</span>
              <span className="text-lg font-medium opacity-70">dBm</span>
            </div>
          ...
          <div className="bg-zinc-800/50 border border-zinc-700 p-6 rounded-2xl">
            <div className="flex items-center justify-between mb-2">
              <span className="text-sm font-bold text-zinc-500 uppercase tracking-wider">Next ODP Capability</span>
              <Info size={16} className="text-zinc-600" />
            </div>
            <div className="flex items-baseline gap-2">
              <span className="text-3xl font-bold text-white">{result.nextODP}</span>
              <span className="text-zinc-500">Kali Split (1:16)</span>
            </div>
